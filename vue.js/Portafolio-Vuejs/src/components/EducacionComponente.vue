...
body {
    ...
    display: grid;
    /* Utiliza el modelo de caja de cuadrícula */
    align-content: center;
    /* Centra verticalmente el contenido dentro de la cuadrícula */
    gap: 2rem;
    /* Espaciado entre los elementos de la cuadrícula */
    padding: 2rem;
    /* Espaciado interno alrededor del cuerpo */
    font-family: "Poppins", sans-serif;
    /* Fuente para todo el texto en la página */
    color: var(--color);
...
ul {
    ...
    --row-gap: 2rem;
    /* Espacio entre las filas de la cuadrícula */
    --line-w: 0.25rem;
    /* Ancho de la línea que conecta los elementos de la lista */
    display: grid;
    /* Usa un layout de cuadrícula */
    grid-template-columns: var(--line-w) 1fr;
    /* Define las columnas de la cuadrícula: la primera es la línea y la segunda es el contenido */
    grid-auto-columns: max-content;
    /* Las columnas se ajustan automáticamente al contenido */
    column-gap: var(--col-gap);
    /* Espacio entre las columnas */
    list-style: none;
    /* Elimina las viñetas predeterminadas de la lista */
    width: min(60rem, 90%);
...
ul::before {
    content: "";
    /* Elemento vacío para crear la línea */
    grid-column: 1;
    /* Coloca la línea en la primera columna de la cuadrícula */
    grid-row: 1 / span 20;
    /* La línea se extiende sobre varias filas */
...
ul li {
    grid-column: 2;
    /* Coloca el contenido en la segunda columna de la cuadrícula */
    --inlineP: 1.5rem;
    /* Espacio interno horizontal dentro de cada ítem */
    margin-inline: var(--inlineP);
    /* Margen horizontal para los ítems */
    grid-row: span 2;
    /* Cada ítem ocupa dos filas en la cuadrícula */
    display: grid;
    /* Usa un layout de cuadrícula dentro de cada ítem */
    grid-template-rows: min-content min-content min-content;
    /* Define tres filas de altura mínima */
}

/* Estilo para la fecha dentro de cada ítem */
ul li .fecha {
    --dateH: 3rem;
    /* Altura de la sección de la fecha */
    height: var(--dateH);
    ...
    position: relative;
    /* Posiciona la fecha relativa a su contenedor */
    border-radius: calc(var(--dateH) / 2) 0 0 calc(var(--dateH) / 2);
    /* Bordes redondeados para la fecha */
}

/* Estilo para la parte inferior de la fecha, que parece un triángulo */
ul li .fecha::before {
    content: "";
    /* Elemento vacío para crear el triángulo */
    width: var(--inlineP);
    /* Ancho igual al espacio interno definido */
    aspect-ratio: 1;
    /* Mantiene una relación de aspecto 1:1 para crear un cuadrado */
    ...
    position: absolute;
    /* Posiciona el triángulo respecto al contenedor de la fecha */
    top: 100%;
    /* Coloca el triángulo justo debajo de la fecha */
    clip-path: polygon(0 0, 100% 0, 0 100%);
    /* Recorta el cuadrado para convertirlo en un triángulo */
    right: 0;
    /* Alinea el triángulo a la derecha de la fecha */
}

/* Estilo para el círculo que conecta la fecha con la línea */
ul li .fecha::after {
    content: "";
    /* Elemento vacío para crear el círculo */
    position: absolute;
    /* Posiciona el círculo respecto al contenedor de la fecha */
    width: 1rem;
    /* Ancho del círculo */
    aspect-ratio: 1;
    /* Mantiene una relación de aspecto 1:1 para crear un círculo */
    background: var(--bgColor);
    /* Color de fondo, utilizando la variable definida */
    border: 0.3rem solid var(--fecha-color);
    /* Borde del círculo, con el color de la fecha */
    border-radius: 50%;
    /* Hace que el elemento sea un círculo perfecto */
    top: 50%;
    /* Centra verticalmente el círculo dentro del contenedor de la fecha */
...
ul li .title {
    ...
    font-weight: 500;
    /* Hace el texto del título un poco más grueso */
}
...
ul li .descripcion {
    ...
    /* Espaciado interno inferior */
    font-weight: 300;
    /* Hace el texto de la descripción más delgado */
}
...
ul li .descripcion::before {
    content: "";
    /* Elemento vacío para crear la sombra */
    position: absolute;
    /* Posiciona la sombra respecto al contenedor del título o descripción */
    width: 90%;
    /* Ancho de la sombra */
    height: 0.5rem;
    /* Altura de la sombra */
    ...
    filter: blur(4px);
    /* Aplica un desenfoque para hacer la sombra más suave */
    transform: translate(-50%, 50%);
...
ul li .title::before {
    ...
    /* Coloca la sombra debajo del título */
}

ul li .descripcion::before {
    z-index: -1;
    /* Coloca la sombra detrás del contenido */
    bottom: 0.25rem;
...
@media (min-width: 40rem) {
    ul {
        ...
        /* Ajusta la cuadrícula para tener tres columnas */
    }

    ul::before {
        grid-column: 2;
        /* Mueve la línea vertical a la segunda columna de la cuadrícula */
    }

    ul li:nth-child(odd) {
        grid-column: 1;
        /* Coloca los ítems impares en la primera columna */
    }

    ul li:nth-child(even) {
        grid-column: 3;
        /* Coloca los ítems pares en la tercera columna */
    }

    /* Ajuste para que el segundo ítem abarque dos filas */
    ul li:nth-child(2) {
        grid-row: 2/4;
        /* El segundo ítem ocupará desde la segunda hasta la cuarta fila */
    }
    ...
    ul li:nth-child(odd) .fecha::before {
        ...
        left: 0;
        /* Alinea el triángulo a la izquierda */
    }
    ...
    ul li:nth-child(odd) .fecha {
        ...
        /* Ajusta los bordes redondeados para los ítems impares */
    }
}
...
.credits {
    margin-top: 1rem;
    /* Espaciado superior para los créditos */
    text-align: right;
    /* Alinea el texto de los créditos a la derecha */
}
